  ...
  <div class="home" v-loading="loading">
    <swiper id="swiperBox" v-bind:options="swiperOption" ref="mySwiper">
      <swiper-slide class="swiper-slide slide-one">
		  ...
		  <transition name="el-zoom-in-bottom">
		    <p v-show="show" class="slogan">FP-CI²MS系统的培育者和开拓者</p>
		  </transition>
      </swiper-slide>
...
// }
.slide-one {
  background: url(../assets/img/home_one.jpg) no-repeat center;
  // background: url(../assets/img/home_top.jpg) no-repeat center;
  background-size: cover;
}
.slide-two {
  background: url(../assets/img/home_two.jpg) no-repeat center;
  // background: url(../assets/img/home_do.jpg) no-repeat center;
  background-size: cover;
}
.slide-three {
  background: url(../assets/img/home_three.jpg) no-repeat center;
